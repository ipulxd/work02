            ...
            deps: ['$ocLazyLoad',
              function ($ocLazyLoad) {
                return $ocLazyLoad.load(['smart-table', 'toaster', 'ui.select']).then(
                  function () {
                    return $ocLazyLoad.load('js/controllers/tenant.js');
                  }
                )
              }]
          }
        })
        .state('app.tenant.list', {
          url: '/list',
          templateUrl: 'tpl/tenant/index.html'
        })
        .state('app.tenant.new', {
          url: '/new',
          templateUrl: 'tpl/tenant/new.html'
        })
        .state('app.tenant.edit', {
          url: '/:id/edit',
          templateUrl: 'tpl/tenant/edit.html'
        })
        .state('app.tenant.detail', {
          url: '/:id/detail',
          templateUrl: 'tpl/tenant/detail.html'
        })
